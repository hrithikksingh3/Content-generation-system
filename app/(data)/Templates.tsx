export default  [
    ...
    
    {
        ...
        desc: "Generate high-quality images using AI based on your given prompt.",
        category: "Image Generation",
        icon: "https://cdn-icons-png.flaticon.com/128/1828/1828919.png",
        slug: "image-generator", // IMPORTANT: must match folder name
        aiPrompt: "Generate an AI image based on the given prompt and style.",
        form: [
...

      {
        ...
        desc: "Upload an Excel file to visualize your data as a bar chart.",
        category: "Data Visualization",
        icon: "https://cdn-icons-png.flaticon.com/128/2921/2921222.png", // Choose an appropriate icon
        slug: "excel-bar-chart",
        aiPrompt: "Generate a bar chart from Excel data",
        form: [] // You can leave this empty if you use a dedicated page
      }
